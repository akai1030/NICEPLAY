...
| | 拿到什麼 | 看到什麼 |
|---|---|---|
| 店員 | 網址 `#staff` ＋ 六碼密碼 | 只有密碼框；進去後只有對戰頁，可回報勝負 |
| 選手 | 投影畫面右下角的 QR（或 `#join=<碼>` 連結） | 專屬唯讀畫面：我在第幾桌、對手是誰、目前第幾名 |

- 密碼不寫在店員網址裡 —— 網址會被轉傳，密碼才是權限
...
#  /test/watch.html?srv=http://127.0.0.1:8799    店員／選手分流
